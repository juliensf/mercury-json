...
from_json_error_to_string(Error) =
    json.error_msg.do_from_json_error_to_string(Error).
...
error_context_and_desc_to_string(Context, ErrorDesc) =
    json.error_msg.do_error_context_and_reader_desc_to_string(Context,
        ErrorDesc).
